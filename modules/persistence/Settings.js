...
const defaultDownloadPath = null; //If defined, will use this path, else will find downloads folder
...
class Settings {
  constructor(
    ...
    downloadThumbnail,
    keepUnmerged,
    avoidFailingToSaveDuplicateFileName,
    calculateTotalSize,
    theme
  ) {
    this.paths = paths;
    ...
    this.avoidFailingToSaveDuplicateFileName =
      avoidFailingToSaveDuplicateFileName == null
        ? false
        : avoidFailingToSaveDuplicateFileName;
  ...
  update(settings) {
    ...
    this.avoidFailingToSaveDuplicateFileName =
      settings.avoidFailingToSaveDuplicateFileName;
